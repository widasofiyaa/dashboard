...
<head>
    ...
    <title>Rekap Data Anomali PDDIKTI</title>
    <!-- Favicon-->
    ...
    <script src="<?php echo base_url("adminBSB/js/config.js"); ?>"></script> <!-- Load file process.js -->

        <!-- Colorpicker Css -->
    <link href="<?php echo base_url() ?>adminBSB/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.css" rel="stylesheet" />

    <!-- Dropzone Css -->
    <link href="<?php echo base_url() ?>adminBSB/plugins/dropzone/dropzone.css" rel="stylesheet">

    <!-- Multi Select Css -->
    <link href="<?php echo base_url() ?>adminBSB/plugins/multi-select/css/multi-select.css" rel="stylesheet">

    <!-- Bootstrap Spinner Css -->
    <link href="<?php echo base_url() ?>adminBSB/plugins/jquery-spinner/css/bootstrap-spinner.css" rel="stylesheet">

    <!-- Bootstrap Tagsinput Css -->
    <link href="<?php echo base_url() ?>adminBSB/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css" rel="stylesheet">

    <!-- Bootstrap Select Css -->
    <link href="<?php echo base_url() ?>adminBSB/plugins/bootstrap-select/css/bootstrap-select.css" rel="stylesheet" />

    <!-- noUISlider Css -->
    <link href="<?php echo base_url() ?>adminBSB/plugins/nouislider/nouislider.min.css" rel="stylesheet" />
